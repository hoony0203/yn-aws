...
ARG NEXT_PUBLIC_GMAP_API_KEY
ARG NEXT_PUBLIC_YEOWOON_ADDRESS
ARG NEXT_PUBLIC_EMAIL
ARG NEXT_PUBLIC_EMAIL_PASSWORD
ARG NEXT_PUBLIC_CLOUDFRONT_URL

ENV NEXT_PUBLIC_GMAP_API_KEY=$NEXT_PUBLIC_GMAP_API_KEY
ENV NEXT_PUBLIC_YEOWOON_ADDRESS=$NEXT_PUBLIC_YEOWOON_ADDRESS
